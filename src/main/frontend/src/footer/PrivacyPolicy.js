...
const PrivacyPolicy = () => {
  return (
    <Context2>
      <p className="titlePri">개인정보 보호방침</p>
      <div>
        <p>
          {"<"} DEVS {">"}('http://meetdevs.shop/'이하 'DEVS')은(는)
        ...
        <p>
          ① {"<"} DEVS {">"} 은(는) 개인정보 보유기간의 경과, 처리목적 달성
        ...
        <p>
          ...
          {"<"} DEVS {">"} 의 개인정보 보호책임자의 승인을 받아 개인정보를
          파기합니다.
        </p>
        <p>2. 파기방법</p>
        <p>
        ...
        <p>
          ① 정보주체는 DEVS 대해 언제든지 개인정보 열람·정정·삭제·처리정지
          요구 등의 권리를 행사할 수 있습니다.
        </p>
        <p>
          ② 제1항에 따른 권리 DEVS 대해 「개인정보 보호법」 시행령
          제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수
          있으며 DEVS(는) 이에 대해 지체 없이 조치하겠습니다.
        </p>
        <p>
        ...
        <p>
          ⑥ DEVS(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구,
        ...
        <p>
          ① DEVS 은(는) 개인정보 처리에 관한 업무를 총괄해서 책임지고,
        ...
        <p>
          ② 정보주체께서는 DEVS 의 서비스(또는 사업)을 이용하시면서 발생한
          모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을
          개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. DEVS
